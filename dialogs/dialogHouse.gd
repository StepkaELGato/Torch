...
func _process(delta: float) -> void:
	# Если окно диалога видно и разрешен ввод
	if dialogWindow.visible == true && can_press:  
		...
		labelWords.text = "Пора выдвигаться на собеседование"  # Устанавливаем текст диалога
	...
	if timer.timeout && Input.is_action_just_pressed("attack"):  
