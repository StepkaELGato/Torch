...
@export var next_scene_path: String = "res://scenes/level_2.tscn"  # Путь к следующей сцене
...
func _process(delta: float) -> void:
	...
	if kill_states.kills >= 4:  # Если количество убийств 4 или больше
	...
	if player_inside and Input.is_action_just_pressed("interaction"):
		if kill_states.kills >= 4:  # Проверка на количество убийств
